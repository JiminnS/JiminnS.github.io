                            ...
                            <form id="articleForm" class="quform" action="save_to_json.php" method="post" enctype="multipart/form-data">
                                <div class="quform-elements">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="quform-element form-group">
                                                <label for="comment">content<span class="quform-required">*</span></label>
                                                <div class="quform-input">
                                        ...
                                        <div class="col-md-12">
                                            <div class="quform-submit-inner">
                                                <button id="save" class="butn md border-0" type="submit" onclick="return confirmInsert();"><span>Save</span></button>
                                            </div>
