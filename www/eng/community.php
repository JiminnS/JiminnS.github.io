    ...
    <div class="main-wrapper">
        ...
        <section class="page-title-section bg-img cover-background top-position left-overlay-dark me-xl-10" data-overlay-dark="9" data-background="../img/necpower/main_slide03.png">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="text-animation text-center text-sm-start" data-in-effect="fadeInUp">Bullentin Board</h1>
                    </div>
                </div>
            </div>
            <div class="sub-sm-title">
                <ul class="wow fadeInUp" data-wow-delay="400ms">
                    ...
                    <li><a href="#!">Bullentin Board</a></li>
                </ul>
            </div>
        </section>
        ...
        <section class="portfolio-details">
            <div class="container">
                <?php include 'community/community.php' ?>
            </div>
        </section>
