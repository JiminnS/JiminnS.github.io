                                    ...
                                    <article class="card card-style3 border-0 border-radius-10 box-shadow overflow-hidden">
                                        <div class="card-body p-0 position-relative overflow-hidden">
                                            <div class="position-relative overflow-hidden border-radius-10 news">
                                                <img src="../img/necpower/news_15.jpg" alt="..." class="border-radius-10 image-hover">
                                            </div>
                                        </div>
                                        <div class="py-1-9 px-1-9 px-xl-2-9">
                                            ...
                                            <h2 class="lh-base mb-3"><a href="#!">Signing of MOA with Indonesia ITPLN</a></h2>
                                            <p class="d-flex justify-content-baseline"><i class="ti-pin text-primary pe-2"></i>We plan to enter Indonesia and expand our sales in the Southeast Asian market by signing an exclusive contract in Korea with ITPLN, Indonesia's electric power agency.</p>
                                        </div>
                                    </article>
                                </div>
                            </div>
