...
<div class="swiper-container d-flex flex-column pt-5 pb-2 py-sm-8 py-md-0 position-relative z-index-9">
    <div class="swiper-wrapper">
            ...
            preload="auto">
                ...
                <div class="col-md-10 col-xl-11 col-xxl-9 mx-auto py-5 px-1-6 px-md-6 px-lg-8 px-xxl-14 text-block"  id="text-1" style=" position: absolute; z-index:100;">
                    <h1 class="lh-1 mt-8 mt-lg-10 font-weight-700" style="text-transform: none">
                        <p class="display-xl-1 big">'2050 Net Zero'</p>
                        <p class="display-xl-5">NEC leads the way in Smart Waste-to-Energy</p>
                    </h1>
                </div>
                ...
                <div class="col-md-10 col-xl-11 col-xxl-9 mx-auto py-5 px-1-6 px-md-6 px-lg-8 px-xxl-14 text-block"  id="text-2" style=" position: absolute; z-index:100;">
                    <h1 class="lh-1 mt-8 mt-lg-10 font-weight-700" style="text-transform: none">
                        <p class="display-xl-4 big">NEC is pursuing the establishment of  </p>
                        <p class="display-xl-5 big">a smart integrated platform for </p>
                        <p class="display-xl-5 big">the entire waste management process</p>
                    </h1>
                </div>
                ...
                <div class="col-md-10 col-xl-11 col-xxl-9 mx-auto py-5 px-1-6 px-md-6 px-lg-8 px-xxl-14 text-block"  id="text-3" style=" position: absolute; z-index:100;">
                    <h1 class="lh-1 mt-8 mt-lg-10 font-weight-700" style="text-transform: none">
                        <p class="display-xl-3 big">NEC Waste Smart Collection</p>
                        <p class="display-xl-4">Operation Management System</p>
                    </h1>
                </div>
                ...
                <div class="col-md-10 col-xl-11 col-xxl-9 mx-auto py-5 px-1-6 px-md-6 px-lg-8 px-xxl-14 text-block"  id="text-4" style=" position: absolute; z-index:100;">
                    <h1 class="lh-1 mt-8 mt-lg-10 font-weight-700" style="text-transform: none">
                        <p class="display-xl-3 big">NEC Smart Incineration</p>
                        <p class="display-xl-4 big"> Power Generation System</p>
                    </h1>
                </div>
                ...
                <div class="col-md-10 col-xl-11 col-xxl-9 mx-auto py-5 px-1-6 px-md-6 px-lg-8 px-xxl-14 text-block"  id="text-5" style=" position: absolute; z-index:100;">
                    <h1 class="lh-1 mt-8 mt-lg-10 font-weight-700" style="text-transform: none">
                        <p class="display-xl-3 big">NEC Secondary Combustion Air</p>
                        <p class="display-xl-4">Semi-Auto Operation System</p>
                    </h1>
                </div>
                ...
                <div class="col-md-10 col-xl-11 col-xxl-9 mx-auto py-5 px-1-6 px-md-6 px-lg-8 px-xxl-14 text-block"  id="text-6" style=" position: absolute; z-index:100;">
                    <h1 class="lh-1 mt-8 mt-lg-10 font-weight-700" style="text-transform: none">
                        <p class="display-xl-4 minus2-letter-spacing big">NEC possesses a real-time smart integrated</p>
                        <p class="display-xl-4 big">operation management system through</p>
                        <p class="display-xl-4 big">the digitalization of incineration power</p>
                        <p class="display-xl-4 big">plant operations based on ICT</p>
                    </h1>
                </div>
        ...
        <div class="swiper-slide video-banner" data-swiper-autoplay="3000" data-slide-type="img">
            ...
            <div class="col-md-10 col-xl-11 col-xxl-9 mx-auto py-5 px-1-6 px-md-6 px-lg-8 px-xxl-14" style=" position: absolute; z-index:100; width: 100%">
                <h1 class="lh-1 mt-8 mt-lg-10 font-weight-700" style="text-transform: none">
                    <p class="display-xl-3 big">"First in Korea to win </p> 
                    <p class="display-xl-4">an EPC contract for a municipal waste </p> 
                    <p class="display-xl-4">incineration power plant in Indonesia"</p></h1>
            </div>
        ...
        <div class="swiper-slide video-banner"  data-swiper-autoplay="8000" data-slide-type="vdo1">
            ...
            <div class="col-md-10 col-xl-11 col-xxl-9 mx-auto py-5 px-1-6 px-md-6 px-lg-8 px-xxl-14 text-block" style=" position: absolute; z-index:100">
                <h1 class="lh-1 mt-8 mt-lg-10 font-weight-700" style="text-transform: none">
                    <p class="display-xl-3 big">Currently installing a MSW</p>
                    <p class="display-xl-4 minus2-letter-spacing">incineration power plant (30 tons/day x 2 units)</p>
                    <p class="display-xl-4">in IKN of Indonesia as part of the capital </p>
                    <!-- <p class="display-xl-4">설치공사 중</p> -->
                </h1>
            </div>
            <div class="col-md-10 col-xl-11 col-xxl-9 mx-auto py-5 px-1-6 px-md-6 px-lg-8 px-xxl-14 text-block" style=" position: absolute; z-index:100">
                <h1 class="lh-1 mt-8 mt-lg-10 font-weight-700" style="text-transform: none">
                    <p class="display-xl-3 big">Scheduled for completion and</p>
                    <p class="display-xl-3">O&M on December 31, 2024</p>
                    <!-- <p class="display-xl-4">설치공사 중</p> -->
                </h1>
            </div>
