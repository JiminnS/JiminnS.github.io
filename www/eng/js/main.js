    ...
    var $window = $(window);
        ...
        $window.on('scroll', function() {
            ...
            if (scroll <= 50) {
                ...
                logochange.attr('src', '../img/necpower/onlylogo-inner.png');
                logodefault.attr('src', '../img/necpower/onlylogo.png');
            } 
            else {
                $("header").removeClass("fixedHeader").addClass("scrollHeader");
                logochange.attr('src', '../img/necpower/onlylogo.png');
                logodefault.attr('src', '../img/necpower/onlyllogo.png');
            }
        });
