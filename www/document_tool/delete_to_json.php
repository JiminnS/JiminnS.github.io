...
$sql = "SELECT * FROM document_kor WHERE title = '$titleToDelete'";
...
if (mysqli_num_rows($result) > 0) {
    ...
    $deleteSql = "DELETE FROM document_kor WHERE title = '$titleToDelete'";
...
// 완료 메시지 출력 또는 리디렉션
echo "<script>
    window.location.href = 'document_delete_kor.php';
    </script>";
?>
