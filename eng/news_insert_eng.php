...
if (!isset($_SESSION['loggedin']) || $_SESSION['loggedin'] !== true) {
    header("Location: news_insert_login.php");
    exit;
}

// 세션을 종료하는 코드를 나중에 실행하거나 특정 시점에 맞춰 실행
session_destroy();
?>
...
<body>
                    ...
                    <div class="col-lg-10">
                        <div class="py-1-9 py-sm-7 px-1-9 px-sm-6 px-xl-8 px-xxl-12">
                            <div class="section-title mb-1-9 mb-sm-5">
                                <span>Insert</span>
                                <h2 class="mb-0">Insert New Article</h2>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="quform-element form-group">
                                                <label for="name">Date<span class="quform-required">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="quform-element form-group">
                                                <label for="name">Category<span class="quform-required">*</span></label>
                                                <div class="quform-input">
                                        ...
                                        <div class="col-md-12">
                                            <div class="quform-element form-group">
                                                <label for="name">Image<span class="quform-required">*</span></label>
                                                <div class="quform-input">
                                        ...
                                        <div class="col-md-12">
                                            <div class="quform-element form-group">
                                                <label for="message">content <span class="quform-required">*</span></label>
                                                <div class="quform-input">
                                        ...
                                        <div class="col-md-12">
                                            <div class="quform-submit-inner">
                                                <button class="butn md border-0" type="submit"><span>Save</span></button>
                                            </div>
    ...
    // 자동완성 항목 리스트
    const categories = ["NEC in the press", "ASEAN News", "Environmental Info"];
