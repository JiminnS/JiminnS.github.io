                    ...
                    <div class="col-lg-10">
                        <div class="py-1-9 py-sm-7 px-1-9 px-sm-6 px-xl-8 px-xxl-12">
                            <div class="section-title mb-1-9 mb-sm-5">
                                <span>Insert</span>
                                <h2 class="mb-0">References Insert</h2>
                            </div>
                            <form id="articleForm" class="quform" action="save_to_json.php" method="post" enctype="multipart/form-data">
                                <div class="quform-elements">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="quform-element form-group">
                                                <label for="name">Document<span class="quform-required">*</span></label>
                                                <div class="quform-input">
                                        ...
                                        <div class="col-md-12">
                                            <div class="quform-submit-inner">
                                                <button id="save" class="butn md border-0" type="submit" onclick="return confirmInsert();"><span>Insert</span></button>
                                            </div>
